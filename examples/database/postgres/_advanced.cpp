/********************************************************************
  ...
  filename:  aries_base/examples/database/postgres/advanced.cpp

  purpose:   Complex real-world scenarios with PostgreSQL database
*********************************************************************/
...
int main() {
  std::cout << "=== PostgreSQL Database Library - Advanced Example ===" << std::endl
            << std::endl;
