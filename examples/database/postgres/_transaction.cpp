/********************************************************************
  ...
  filename:  aries_base/examples/database/postgres/transaction.cpp

  purpose:   ACID transaction management with PostgreSQL database
*********************************************************************/
...
int main() {
  std::cout << "=== PostgreSQL Database Library - Transaction Example ==="
            << std::endl
            << std::endl;
