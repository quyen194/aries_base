/********************************************************************
  ...
  filename:  aries_base/examples/database/postgres/prepare.cpp

  purpose:   Use prepared statements safely with PostgreSQL database
*********************************************************************/
...
int main() {
  std::cout << "=== PostgreSQL Database Library - Prepared Statement Example ==="
            << std::endl
            << std::endl;
  ...
  try {
    // Create PostgreSQL database for this example
    auto db = DatabaseFactory::Create(DBType::PostgreSQL);
