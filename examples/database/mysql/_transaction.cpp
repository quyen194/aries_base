/********************************************************************
  ...
  filename:  aries_base/examples/database/mysql/transaction.cpp

  purpose:   ACID transaction management with MySQL database
*********************************************************************/
...
int main() {
  std::cout << "=== MySQL Database Library - Transaction Example ==="
            << std::endl
            << std::endl;
