/********************************************************************
  ...
  filename:  aries_base/examples/database/mssql/settings.hpp

  purpose:   MSSQL database settings for examples
*********************************************************************/


// -----------------------------------------------------------------------------
#ifndef ARIES_BASE_EXAMPLES_DATABASE_MSSQL_SETTINGS_HPP
#define ARIES_BASE_EXAMPLES_DATABASE_MSSQL_SETTINGS_HPP
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
#endif  // ARIES_BASE_EXAMPLES_DATABASE_MSSQL_SETTINGS_HPP
// -----------------------------------------------------------------------------
