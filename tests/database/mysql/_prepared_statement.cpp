/********************************************************************
  ...
  filename:  aries_base/tests/database/mysql/prepared_statement.cpp

  purpose:   Parameter binding and statement reuse for MySQL database
*********************************************************************/
...
void test_bind_integer() {
  try {
    ...
    auto result = db->Execute("SELECT value FROM test WHERE id = 0");
