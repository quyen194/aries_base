/********************************************************************
  ...
  filename:  aries_base/tests/database/mssql/transaction.cpp

  purpose:   ACID transaction semantics tests for MSSQL database
*********************************************************************/
...
void test_begin_commit() {
  try {
    ...
    assert(db->Execute("IF OBJECT_ID(N'dbo.accounts', N'U') IS NOT NULL DROP TABLE dbo.accounts") != nullptr);
